...
export const STEPS: Step[] = [
  ...
  { id: "leake", name: "Enroll in Leake Agency Mortgage Protection Sales Mastery", group: "Training", note: "$25. Get through Module 8.", links: [l("Purchase training", "https://training.theleakeagency.com/p/effective-mortgage-protection-sales?affcode=1444119_bbt65tue")] },
  ...
  { id: "flat_tire", name: "Watch the Flat Tire List video and start Flat Tire Appointments", group: "Business launch", links: [l("Watch video", "https://vimeo.com/user181470649/flattirelist?share=copy")] },

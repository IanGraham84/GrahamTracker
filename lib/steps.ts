...
export const STEPS: Step[] = [
  ...
  { id: "onboarding_login", name: "Create login for Onboarding Application", group: "Getting started", note: "Use your new work email and create a password — stop there for now.", links: [l("Open portal", "http://www.quilityonboarding.com/")], unlicensedOnly: true },
  { id: "course_done", name: "Finish 20 hour prelicensing course", group: "Getting started", note: "This takes most agents 3-7 days.", unlicensedOnly: true },
  { id: "7", name: "Complete Onboarding Application", group: "Licensing", licensedGroup: "Getting started", note: "Approval 24-48 hrs.", links: [l("Open application", "http://www.quilityonboarding.com/")] },
  ...
  { id: "leake", name: "Enroll in Leake Agency Mortgage Protection Sales Mastery", group: "Training", note: "$25. Get through Module 8.", links: [l("Purchase training", "https://checkout.teachable.com/secure/1444119/checkout/order_x47bqb0r?coupon_code=GRAHAM20")] },
  { id: "quigley", name: "Role Play Appointment Setting with Quigley", group: "Training", note: "Choose Ian as the 130 so he can see your progress and help coach. Practice 25 new mortgage holders and 25 aged leads.", links: [l("Open Quigley", "https://quigley.momentousfinancialpartners.com/sign-in")] },
  { id: "11", name: "Received 'Welcome to Symmetry' email", group: "Contracting", note: "Watch the HQ Orientation video and proceed directly to Fast Start. Follow the Fast Start steps verbatim, pausing and completing tasks as it coaches you to do so." },
  { id: "12", name: "Create Sure LC account & set up profile", group: "Contracting", note: "Use the Fast Start training for guidance. No red/yellow flags." },
  ...
  { id: "17", name: "Complete SureLC carrier contracts", group: "Contracting", note: "No LTC or annuity training needed. Can take up to 2 weeks for writing numbers." },
  ...
  { id: "20", name: "Complete Funnel, Navigator, and LeadStream training", group: "Training", note: "Log into HQ and use the top left 9-dot menu to go to QU LMS, and watch the trainings for all 3 Quility Tech Platforms." },
  ...
  { id: "activation_call", name: "Text your upline to schedule an Activation Call with your mentor to establish your Game Plan", group: "Business launch" },
  { id: "flat_tire", name: "Watch the Flat Tire List video and start Flat Tire Appointments", group: "Business launch", links: [l("Watch video", "https://vimeo.com/user181470649/flattirelist?share=copy"), l("Flat Tire CQF", "https://drive.google.com/file/d/1S_rcQgrwAPUlVZ7PXYM_IR42-YORCgF-/view?usp=sharing")] },
  ...
  { id: "26", name: "Purchase first set of leads (Based on the Game Plan decided during your Activation Call with your mentor)", group: "Business launch", links: [l("Watch tutorial", "https://hq.quility.com/summit/first-lead-order")] },
  ...
  { id: "activity_report", name: "Print/Save Activity Report", group: "Business launch", note: "Track your dials, contacts, and appointments to put into your Counting What Counts tracker.", links: [l("Open Activity Report", "https://drive.google.com/file/d/1WHS4Q4Gy_Hn_IkQhp20CMRjJtatl_ve6/view?usp=sharing")] },

...
export const STEPS: Step[] = [
  ...
  { id: "orientation_call", name: "Attend New Agent Orientation Call", group: "Getting started", note: "Every Tuesday at 12 PM EST. You only need to attend once.", links: [l("Join Zoom", "https://us02web.zoom.us/j/5574525093?pwd=K0lTT2lzejJOWlRmSzcwcVlPNkYwdz09")] },
  ...
  { id: "onboarding_login", name: "Create logins to onboarding portal", group: "Getting started", note: "Use your new work email and create a password — stop there for now.", links: [l("Open portal", "http://www.quilityonboarding.com/")], unlicensedOnly: true },
  ...
  { id: "10", name: "Complete Anti-Money Laundering (AML) course", group: "Contracting", links: [l("AML course", "https://www.webce.com/catalog/courses/course-information?c=9317")] },
  ...
  { id: "19", name: "Complete HQ Summit Training through Basecamp", group: "Training", note: "~3-4 hours", links: [l("Open Summit", "https://hq.quility.com/summit")] },
  { id: "20", name: "Complete Navigator Training in HQ", group: "Training", links: [l("Watch walkthrough", "https://www.loom.com/share/ae8b5889c0384620a07ea2b14dac6cd1?sid=976049f6-790c-4521-bf8d-139203188e7a")] },
  ...
  { id: "22", name: "Watch New Agent Activation recording", group: "Training", note: "10 min", links: [l("Watch recording", "https://vimeo.com/1028199267?share=copy#t=0")] },
  { id: "23", name: "Print/save Levels of Leadership, Promo Guidelines, 4 Keys, 4 Cornerstones", group: "Training", links: [l("Levels of Leadership", "https://hq.quility.com/cms/document/view/44534"), l("Promo Guidelines", "https://hq.quility.com/page/promotion-guidelines-and-bonuses"), l("Core Values", "https://hq.quility.com/page/symmetry-core-values"), l("4 Keys", "https://hq.quility.com/api/public/document/57508/view/four-keys-successful-week"), l("4 Cornerstones", "https://hq.quility.com/api/public/document/62330/view/four-cornerstones-of-success")] },
  { id: "24", name: "Reach out to your upline to schedule a Goal Setting conversation", group: "Business launch" },
  { id: "flat_tire", name: "Flat Tire Appointments", group: "Business launch", links: [l("Flat Tire Script", "https://drive.google.com/file/d/1785rgWe9uSYXPXL2j_GTGghNBjWH5m3N/view?usp=sharing"), l("Flat Tire CQF", "https://docs.google.com/document/d/1O2mrqpp9bUs69FNv4pR54MWPvmf4iwCFgTBSxxmJ-z0/edit?usp=sharing")] },
  { id: "25", name: "Make your business known on social media", group: "Business launch", links: [l("Social guide", "https://docs.google.com/document/d/1sQVEQ437D6Lwr1KZBIopbXQavHfaYPosi_WEU79ZglY/edit?tab=t.0")] },
  ...
  { id: "27", name: "Print/save CQF for dialing", group: "Business launch", links: [l("Open CQF", "https://drive.google.com/file/d/1v3TzBQMM7-2vx4dDj5mvZae8OWll5YDV/view?usp=sharing")] },
  ...
  { id: "28", name: "Bookmark underwriting cheat sheet", group: "Business launch", links: [l("Open cheat sheet", "https://docs.google.com/spreadsheets/d/1vd7cjSb3wB6FlH--YrLfzVur3XOclbYSAp8hP_rhuNs/edit?usp=sharing")] },
  { id: "29", name: "Bookmark sfgquotes.com", group: "Business launch", links: [l("Open SFGQuotes", "http://sfgquotes.com/")] },
  { id: "30", name: "Begin using the SimplicityAI Counting What Counts tracker", group: "Business launch", links: [l("Open tracker", "https://simplicityai.netlify.app/?join=SFG0016490&by=Jordan%20Hunt")] },
  ...
  { id: "33", name: "Watch Underwriting Basics video", group: "Go time!", note: "23 min", links: [l("Watch video", "https://www.loom.com/share/95d0ba5c23c44a0296313df49b362c8e?sid=5f1bc87e-0d9b-42be-bcd3-23a6c9214849")] },
  { id: "34", name: "Watch Running the Appointment video if needed", group: "Go time!", links: [l("Running the Appointment", "https://www.larsenlifegroup.com/appointments")] },
  ...
  { id: "35", name: "Congrats! You did it once, do it again!", group: "Go time!", links: [l("Wash Rinse Repeat", "https://www.loom.com/share/1089c1a6c20543a0927c9029d3f29e62")] },
];
